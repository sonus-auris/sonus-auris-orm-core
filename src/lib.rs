...
//!
//! Canonical, opaque SeaORM boundary for the `sonus-auris` organization.
//!
//! The crate consumes the Sonus Auris schema slice generated from
...
compile_error!("sonus-auris-orm-core requires the read-only feature; read-write includes it");
...
#[doc = r#"
```compile_fail
use sonus_auris_orm_core::{WriteContext, connect_read_write, write};
```
"#]
