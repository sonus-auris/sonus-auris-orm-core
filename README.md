...
Shared **SeaORM** entity/query crate for the `sonus-auris` organization.
...
org-wide policy in
[`sonus-auris/.github/SERVICE_AND_DATA_ARCHITECTURE.md`](https://github.com/sonus-auris/.github/blob/main/SERVICE_AND_DATA_ARCHITECTURE.md)
